<div class="p-20 space-y-10">
    <div
        class="w-full
        bg-gray-100 shadow-md rounded-lg font-lex h-auto border hover:border-pink-600 hover:shadow-blue-200 transition-all duration-500 ease-in-out flex">
        <div class="overflow-hidden rounded w-1/3">
            <img src="{{ asset('images/prod-1.webp') }}" alt="product-image"
                class="w-full h-80 object-cover transition duration-500 ease-in-out hover:scale-105">
        </div>
        <div
    ...
    <div class="w-full grid grid-cols-1 sm:grid-cols-3 md:grid-cols-4 gap-5         ">
        <livewire:item-card />
        <livewire:item-card />
        <livewire:item-card />
        <livewire:item-card />
